...
export function CreateAgentDialog({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : t.agent.createFailed);
      setCreating(false);
    }
  };
  ...
  return (
    <Dialog open onOpenChange={(v) => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{t.agent.createDialogTitle}</DialogTitle>
          <DialogDescription>
            {t.agent.createDialogDesc}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 min-w-0">
          <div>
            ...
            <Input
              ...
              placeholder={t.agent.nameExamplePlaceholder}
              className="mt-1"
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <span className="truncate font-medium">
                      {runtimesLoading ? t.agent.loadingRuntimes : (selectedRuntime?.name ?? t.agent.noRuntimeAvailable)}
                    </span>
        ...
        <DialogFooter>
          ...
          >
            {creating ? t.agent.creating : t.agent.createBtnShort}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
